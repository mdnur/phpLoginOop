...
<?php require_once($_SERVER['DOCUMENT_ROOT']."/lib/Session.php");?>
<?php
Session::init();
            ...
            <div class="container mx-auto">
                <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <?php if(Session::itsLogin() ):?>
                         <a href="index.php" class="whitespace-no-wrap text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900">
                           Home
                        </a>
